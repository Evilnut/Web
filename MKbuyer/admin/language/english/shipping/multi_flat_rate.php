...
$_['help_charge_group']					= 'Use a single letter or number (case-insensitive) to set a charge&#39;s group. Charges of the same group can be combined within the "Charge Combinations" tab.';
...
$_['help_charge_type']					= 'Select the basis for the charge: a simple charge (flat rate or per item), a charge based on brackets (quantity, total, weight, etc.), or a charge calculated using another shipping method.';
$_['help_charge_charges']				= 'For "Simple Charges", just enter the flat or per item value (such as 5.00). For "Bracket Charges", separate brackets by commas or new lines, and enter them in the format: <b>From - To = Cost / Per</b><br /><br />The "Per" setting is optional. For example, to charge $6.00 for 1 to 3 items, and $2.00 per item for 4 or more items, you would choose "Quantity" and enter:<br /><div class="text-left" style="margin: 10px">1-3 = 6.00<br />4-9999 = 2.00 / 1</div>For "Other Shipping Method" charges, enter one or more titles of the rate to charge (such as Ground). Separate multiple titles by commas or new lines. The charge will be the first eligible rate that contains one of these titles. If left blank, the first rate returned will be chosen.';
...
$_['help_cart_criteria']				= 'Enter a minimum value (such as 5.00) or a range (such as 3.3-10.5) that the cart or individual items must meet. A single value indicates <b>at least</b> that value. For example, if you set a criteria of 5.00, any value of 5.00 or more will be eligible.<br /><br />Ranges are inclusive of the end values. Separate multiple ranges using commas. To specify an exact value, use a range like 5.00-5.00. <br /><br />Values are normally compared only against eligible items (i.e. those that qualify for the charge based on other rules). To compare values against all items in the cart, including ineligible ones, choose a comparison containing "entire cart".';
...
$_['help_option_value']					= 'Enter an option value in the auto-complete field. Make sure to leave the option_value_id in the square brackets [ and ] since that is used for comparison purposes. For more complex requirements, use the Product Groups feature.';
...
//------------------------------------------------------------------------------
$_['help_heading']						= 'The heading under which these shipping options will appear. HTML is supported.<br /><br />Use the shortcode [quantity] to display the number of items in the cart.<br /><br />This heading is for';
$_['help_charge_title']					= 'The title displayed to the customer. HTML is supported.<br /><br />Use the shortcode [quantity] to display the number of items in the cart.<br /><br />This title is for';

$_['column_group']						= 'Sort Order';
$_['help_charge_group']					= 'Enter the sort order in which the charges will appear. If you leave the value blank, the charge will be disabled.';

$_['help_charge_type']					= 'Select the basis for the charge: a flat rate or a per item rate.';
$_['help_charge_charges']				= 'Enter the flat rate or per item rate charge, as a decimal value using periods (.) for decimal values. To use a percentage of the order total as the charge, enter the value followed by a percent sign (%).';
?>