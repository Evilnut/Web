        ...
        <div id="tab-general" class="vtabs-content">
          <table class="form">
            <tr>
              ...
              <td><select name="standard_cost_tax_class_id">
            ...
            <tr>
              ...
              <td><select name="standard_cost_status">
            ...
            <tr>
              ...
              <td><input type="text" name="standard_cost_sort_order" value="<?php echo $standard_cost_sort_order; ?>" size="1" /></td>
            </tr>
          </table>
        </div>
        <?php foreach ($geo_zones as $geo_zone) { ?>
