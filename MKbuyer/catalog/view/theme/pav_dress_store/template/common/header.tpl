	...
	<div class="container">
		<div class="mainnav-inner">
			<div class="row-fluid">
				...
				<nav id="mainmenu" class="span10 offset2"><div class="navbar">
...
if( $modules ){
?>
<section id="pav-slideshow" class="pav-slideshow hidden-phone">
  <?php foreach ($modules as $module) { ?>
   <?php echo $module; ?>
  <?php } ?>
</section>
...
?>
<section class="pav-promotion" id="pavo-promotion">
	<div class="container">
...
<?php }  else { ?>
<?php if( isset($themeConfig['static_top'][$LANGUAGE_ID]) ) { ?>
			<section class="pav-promotion" id="pavo-promotion">
				<div class="container bg-promotion">
					<div class="row-fluid">
					<?php echo html_entity_decode( $themeConfig['static_top'][$LANGUAGE_ID], ENT_QUOTES, 'UTF-8' ); ?>
					</div>
				</div>
			</section>
			 <?php } ?>
