		...
		<?php foreach( $tabs as $tab => $products ) { 
			...
			<div class="tab-pane box-products tabcarousel<?php echo $id; ?> slide" id="tab-<?php echo $tab.$id;?>">				
				...
				<div class="carousel-controls">
					<a class="carousel-control left no-box" href="#tab-<?php echo $tab.$id;?>"   data-slide="prev">&lsaquo;</a>
					<a class="carousel-control right no-box" href="#tab-<?php echo $tab.$id;?>"  data-slide="next">&rsaquo;</a>
				</div>
				<?php } ?>
